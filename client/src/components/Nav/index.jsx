...
//       <Navbar.Brand as={Link} href="https://github.com/JoshON5/websight">
//         <img src="../src/assets/websight.png" className="mr-3 h-12 sm:h-9" alt="WebSight Logo" />
//       </Navbar.Brand>
//       <Navbar.Toggle />
//       <Navbar.Collapse>
...
const Nav = () => {
    return (
      <nav className="bg-black border-gray-200 flex fixed w-screen">
